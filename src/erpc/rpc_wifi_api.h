/*
 * Generated by erpcgen 1.7.4 on Wed Oct 28 10:08:45 2020.
 *
...
enum _rpc_wifi_mbedtls_ids
{
    ...
    krpc_wifi_mbedtls_rpc_wifi_start_ssl_client_id = 4,
    krpc_wifi_mbedtls_rpc_wifi_stop_ssl_socket_id = 5,
    krpc_wifi_mbedtls_rpc_wifi_data_to_read_id = 6,
    krpc_wifi_mbedtls_rpc_wifi_send_ssl_data_id = 7,
    krpc_wifi_mbedtls_rpc_wifi_get_ssl_receive_id = 8,
    krpc_wifi_mbedtls_rpc_wifi_verify_ssl_fingerprint_id = 9,
    krpc_wifi_mbedtls_rpc_wifi_verify_ssl_dn_id = 10,
};
